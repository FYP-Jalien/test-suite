...
expected_lines=(
    ...
    "{Site=JTestSite, Partition=,,, CE=ALICE::JTestSite::firstce, Platform=Linux-x86_64, Host=localhost.localdomain, TTL=87000, alienCm=localhost.localdomain:10000, workdir=/var/lib/condor/execute/dir_118, Localhost=worker1, CEhost=localhost.localdomain, Disk=1427533644, CPUCores=1, CVMFS=1"
    "Resources available: 1 CPU cores and 1394075 MB of disk space"
 ...
 "Type = \"Job\";"
    ...
    "jalien"
    "The recomputed disk space is 1394075 MB"
